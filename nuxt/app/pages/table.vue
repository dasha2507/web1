...
<template>
  <div class="bg-gray-50 flex flex-col items-center min-h-screen p-4 font-sans text-slate-800">
    ...
    <div class="w-full max-w-6xl flex justify-end px-6 mt-8 -mb-4">
      <NuxtLink
        to="/categories"
        class="bg-blue-100 hover:bg-blue-200 text-blue-700 font-bold py-2.5 px-6 rounded-lg text-sm transition-colors shadow-sm"
      >
